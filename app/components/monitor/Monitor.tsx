...
const FilterButton = ({ label }: { label: string }) => {
  return (
    <div className="w-[80px] flex justify-center items-center bg-[#ECF2F8] px-3 py-1 border-[1px] border-[#D9D8DF] rounded-md">
      <p className="text-[#A1B1D1] text-[6px] font-light ">{label}</p>
      <MdKeyboardArrowDown className="text-[#A1B1D1] text-[6px] font-light " />
    </div>
  );
};
...
export default function Monitor() {
  return (
    <div className="w-[190px] h-[400px] fixed bg-white rounded-md p-3">
